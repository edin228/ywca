  ...
  return (
    <div className="-mt-10 mb-8 z-40 px-0 md:px-10">
      <div className="py-8 action-itms-bg rounded-lg flex flex-col w-full items-center justify-center">
        <h3 className="font-semibold text-2xl w-1/2 text-center mb-4">
        ...
        <div className="flex flex-col justify-center md:flex-row w-full items-center">
          <a
            ...
            target="_blank"
            className="cursor-pointer mb-4 md:mb-0 md:mr-2 text-xl shadow-lg rounded bg-red-400 px-8 py-2 text-white transition duration-500 ease hover:bg-indigo-900"
          >
            Volunteer
          </a>
          <Link href="/mission">
            <div className="cursor-pointer mb-4 md:mb-0 md:mr-2 text-xl shadow-lg rounded bg-red-400 px-8 py-2 text-white transition duration-500 ease hover:bg-indigo-900">
              {" "}
              Our Mission
            </div>
          </Link>
